...
class GivenCircumstancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create given_circumstance" do
    assert_difference('GivenCircumstance.count') do
      post given_circumstances_url, params: { given_circumstance: { character_background: @given_circumstance.character_background } }, as: :json
    end
  ...
  test "should update given_circumstance" do
    patch given_circumstance_url(@given_circumstance), params: { given_circumstance: { character_background: @given_circumstance.character_background } }, as: :json
    assert_response 200
  end
